...
define('APP_REG_URL', 'https://raw.githubusercontent.com/dimark57/dimark57/master/index.php'); // the same URL you should set when adding a new application in Bitrix24
